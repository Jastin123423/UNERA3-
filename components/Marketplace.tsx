                        ...
                        <div>
                            <div className="flex items-center justify-between gap-3 mb-4">
                                <div className="flex items-center gap-3 overflow-hidden">
                                    <img src={product.sellerAvatar} alt="Seller" className="w-12 h-12 rounded-full object-cover border-2 border-[#1877F2] flex-shrink-0" />
                                    <div className="overflow-hidden">
                                        <h4 className="text-[#E4E6EB] font-bold text-lg leading-tight truncate">{product.sellerName}</h4>
