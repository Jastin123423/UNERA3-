...
export const ChatWindow: React.FC<ChatWindowProps> = ({ 
    ...
    const isRecipientTyping = getUserStatus ? getUserStatus(recipient.id).typing : false;
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div className="cursor-pointer">
                        ...
                        <span className="text-[13px] text-[#8696a0] block leading-tight">
                            {isRecipientTyping ? 'typing...' : 
                             getUserStatus ? (getUserStatus(recipient.id).formattedLastSeen || 'online') : 'online'}
                        </span>
                    </div>
                </div>
